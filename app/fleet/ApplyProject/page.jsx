...
// Mock project details tailored for the fleet manager context
const mockProject = {
  id: "PRJ-2026-092",
  title: "Bole-Modjo Bulk Aggregate Transport & Fleet Logistics",
  clientName: "Apex Logistics & Transit PLC",
  location: "Addis Ababa to Modjo Corridor",
  duration: "60 Days",
  budgetRange: "$18,000 - $22,000",
  deadline: "Aug 25, 2026",
  description:
    "Large-scale bulk aggregate haulage across major transport corridors. We require an experienced Fleet Manager to coordinate truck dispatching, manage maintenance schedules, oversee driver rotations, and monitor real-time telematics and fuel efficiency metrics.",
};

// Inline Footer component specifically styled for Fleet Managers
function FleetManagerFooter() {
  return (
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-200">
            C-TMS Fleet Operations Hub
          </span>
          <span className="text-slate-600">|</span>
          <span>Logistics Dispatch Terminal v3.1</span>
        </div>

        <div className="flex items-center gap-6">
          <span className="flex items-center gap-1.5 hover:text-slate-200 cursor-pointer">
            <Phone className="w-3.5 h-3.5 text-amber-400" /> Fleet Support Line
          </span>
          <span className="flex items-center gap-1.5 hover:text-slate-200 cursor-pointer">
            <Mail className="w-3.5 h-3.5 text-amber-400" /> Telematics Desk
          </span>
        </div>
...
export default function ApplyProjectPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatusMessage({
        type: "success",
        text: "Fleet Manager proposal submitted successfully! The transport team will review your fleet oversight credentials.",
      });
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#030712] text-slate-100 font-sans">
      ...
      <header className="bg-[#070e20] border-b border-slate-800 px-6 py-4 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            Back to Fleet Manager Terminal
          </Link>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 lg:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-2xl bg-[#070e20] border border-slate-800 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-bold uppercase tracking-wider">
              ...
              <span>Logistics Role Overview</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-[#0b1329] border border-slate-800 flex items-start gap-3">
              ...
              <div className="text-xs">
                <p className="font-bold text-slate-200">
                  Verified Fleet Profile Attached
                </p>
                <p className="text-slate-400 mt-0.5 text-[11px] leading-relaxed">
                  Your transport management record, telematics integration
                  history, and safety compliance accreditations will be attached
                  automatically.
                </p>
              </div>
            </div>
        ...
        {/* RIGHT PANEL: FLEET MANAGER APPLICATION FORM */}
        <div className="lg:col-span-7 bg-[#070e20] p-6 lg:p-8 rounded-2xl border border-slate-800 space-y-6">
          <div>
            <div className="flex items-center gap-2">
              <UserCheck className="w-5 h-5 text-amber-400" />
              <h2 className="text-xl font-bold text-white tracking-tight">
                Submit Fleet Proposal
              </h2>
            </div>
            <p className="text-xs text-slate-400 mt-1">
              Provide your management rates, fleet scaling capacity, and transit
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="daily">Daily Operations Rate</option>
                  <option value="total">Total Corridor Contract</option>
                </select>
              </div>
            </div>

            {/* Fleet Metrics & Specifications */}
            <div className="p-4 rounded-xl bg-[#0b1329] border border-slate-800 space-y-4">
              <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-amber-400">
                <FileCheck2 className="w-4 h-4" /> Fleet Scale & Telematics
              ...
              <div>
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. Heavy Dump Trucks, GPS Telematics Integration, IoT Fleet Tracking"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-1.5">
                    Fleet Management Experience (Years){" "}
                    <span className="text-amber-500">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-1.5">
                    Average Trucks Managed Simultaneously{" "}
                    <span className="text-amber-500">*</span>
                  </label>
                  <input
                    type="number"
                    name="managedTrucksCount"
                    required
                    min="1"
                    value={formData.managedTrucksCount}
                    onChange={handleChange}
                    placeholder="e.g. 25"
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#070e20] border border-slate-700 text-slate-100 text-xs focus:outline-none focus:ring-2 focus:ring-amber-500/50 placeholder:text-slate-600"
                  />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Highlight corridor transport management experience, real-time dispatch optimization, fuel management systems, or driver rotation workflows..."
            ...
            >
              {loading ? (
                <span>Submitting Fleet Proposal...</span>
              ) : (
                <>
                  <Send className="w-4 h-4" />
                  <span>Submit Fleet Manager Application</span>
                </>
              )}
            </button>
          </form>
